...
# Auxiliary function to replace missing values with the multiple imputation
...
if (!is.null(distances) && !all(is.na(distances))) {
  knitr::kable(distances, caption = "Minkowski Distances")
} else {
...
if (!is.null(distances) && !all(is.na(distances))) {
  plot_minkowski_distances(distances, "Minkowski Distance Between Groups")
} else {
