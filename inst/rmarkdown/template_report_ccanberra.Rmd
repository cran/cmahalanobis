...
ccanberra <- function(dataset, formula, plot = TRUE, plot_title = "Canberra Distance Between Groups") {
  ...
  # Extract the response and the predictor variables from the formula
...
if (!is.null(distances) && !all(is.na(distances))) {
  knitr::kable(distances, caption = "Canberra Distances")
} else {
...
if (!is.null(distances) && !all(is.na(distances))) {
  plot_canberra_distances(distances, "Canberra Distance Between Groups")
} else {
